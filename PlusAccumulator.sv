...
(
    input logic CLK, 
    input logic RST,
    input logic signed [16:0] In [7:0], 

    output logic signed [19:0] Out 
); 

//stage 1
logic signed [17:0] stage1Sum [3:0] ;
logic signed [17:0] stage1Reg [3:0] ;
//stage 2
logic signed [18:0] stage2Sum [1:0] ;
logic signed [18:0] stage2Reg [1:0] ;
//stage 3
